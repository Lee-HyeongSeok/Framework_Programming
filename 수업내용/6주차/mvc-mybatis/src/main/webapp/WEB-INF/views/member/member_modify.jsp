...
<body>
	<div align=center>
		...
		<form name=form1 action="http://localhost:2020/myweb/member/modify" method="post">
			<table>
			<tr><th>LiginID</th><td><input type="text" name="id" readonly value="${student.id}"></td></tr>
			<tr><th>LiginPWD</th><td><input type="text" name="passwd"  value="${student.passwd}"></td></tr>
