...
<body>
	<div align=center>
		<header>학생 목록</header>
		<c:url value="/member/register" var="url"/><a href="${url}">학생 등록</a>
		<table>
			<tr>
				<th>ID</th><th>PWD</th><th>USERNAME</th><th>SNUM</th><th>DEPART</th><th>MOBILE</th><th>EMAIL</th>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<c:url value="/member/modify?id=${member.id}" var="url"/><a href="${url}">정보 보기</a>
				</td>
			</tr>
			</c:forEach>
		</table>
